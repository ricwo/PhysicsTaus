...
def makeCanvas(name):
   ...
   # ROOT.gStyle.SetPadRightMargin (0.10) # for 10e3  
    ROOT.gStyle.SetPadRightMargin (0.12) # for 10e3        
...
#    h.GetXaxis().SetTitle("Jet2 #eta [MeV]")
...
#    leg = getLegend(0.62, 0.76, 0.99, 0.86) # top right
    leg = getLegend(0.62, 0.77, 0.88, 0.86) # top right smaller size
#
#    leg = getLegend(0.18, 0.76, 0.55, 0.86) # top left
#    leg = getLegend(0.38, 0.23, 0.75, 0.33) # bottom middle
    
    #leg = getLegend(0.87, 0.28, 0.97, 0.38) # bottom right

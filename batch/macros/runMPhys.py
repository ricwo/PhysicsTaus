...
def main():
    ...
    #
    root_files = sorted(config.findInputLocalFiles(args, options.filekey, options.dirskey, save_files=options.save_files, print_files=False))
    ...
    #
    import ROOT
    from PhysicsProject.PhysicsProjectMPhys import prepareJobConfig

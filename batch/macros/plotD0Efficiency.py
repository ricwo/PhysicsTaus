...
def plotEfficiency(rfiles, can, hpath):
    ...
    for rfile in rfiles:
        ...
        if '/ElecTruthMatchW1/' in hpath:
            ...
            sDenom = 7313650
            bDenom = 2120163
	    starx  = 100.0 * 1101397.0 / sDenom
            stary  = 100.0 *   15011.0 / bDenom

        elif '/MuonTruthMatchW1/' in hpath:
            h2path = hpath.replace('/MuonTruthMatchW1/', '/MuonTruthMatchW0/')
            sDenom = 7959136
            bDenom = 6021061
            starx  = 100.0 * 1335387.0 / sDenom
            stary  = 100.0 *   17906.0 / bDenom
            ...
            sDenom = 901265
            bDenom = 226132
            starx  = 100.0 * 5099.0 / sDenom
            stary  = 100.0 *  393.0 / bDenom

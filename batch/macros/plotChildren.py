...
def getHist(rfile, hpath):
    ...
    h.GetXaxis().SetBinLabel(2 , '#color[0]{|}e#color[0]{|}')
    h.GetXaxis().SetBinLabel(3 , '#color[0]{|}#pi^{#pm}#color[0]{|}')
    h.GetXaxis().SetBinLabel(4 , '#color[0]{|}other#color[0]{|}')

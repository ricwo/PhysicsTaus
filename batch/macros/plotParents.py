...
def getHist(rfile, hpath):
    ...
    h.GetXaxis().SetBinLabel(2 , '#color[0]{|}#tau_{W}#color[0]{|}')
    h.GetXaxis().SetBinLabel(3 , '#color[0]{|}#tau_{nonW}#color[0]{|}')
    h.GetXaxis().SetBinLabel(4 , '#color[0]{|}B#color[0]{|}')
    h.GetXaxis().SetBinLabel(5 , '#color[0]{|}D#color[0]{|}')
    h.GetXaxis().SetBinLabel(6 , '#color[0]{|}other#color[0]{|}')

...
def plotEfficiency(rfiles, can, hpath):
    ...
    for rfile in rfiles:
        ...
        for i in range(0, h.GetNbinsX() + 1): # note bin number nbins + 1 is empty
        ...
        #mg.GetXaxis().SetLimits(15, 103 * sInt/sDenom)
        #mg.GetXaxis().SetLimits(13, 16)
        #mg.SetMinimum(0.156)
        #mg.SetMaximum(0.1)

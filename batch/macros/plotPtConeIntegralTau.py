...
def getOutName(name):
    ...
    if   'Elec' in name:
        name = 'ElecEtCone40Ratio'
    elif 'Tau' in name:
        name = 'TauEtCone40Ratio'
    elif 'Muon' in name:
	name = 'MuonEtCone40Ratio'
    else:
        name = 'TauEtConeRatio'
...
def plotIntegralRatio(rfiles, can, hpath):
    ...
    for rfile in rfiles:
        ...
        for i in range(0, h.GetNbinsX()+1, 1): # note bin number nbins + 1 is empty
...
def main():         
    ...
    for r in regions:
        ...
        for h in hists:
            if h == 'ElecTruthMatchW1/NewEtTopoCone30' or h == 'MuonTruthMatchW1/NewEtTopoCone30' or h == 'TauTruthMatchW1/NewEtTopoCone30':

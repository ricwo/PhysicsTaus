...
#    leg = getLegend(0.18, 0.76, 0.55, 0.86) # top left
    ...
    #leg = getLegend(0.59, 0.28, 0.90, 0.38) # bottom right
    ...
    if plotLine:
        ...
        line = ROOT.TLine(linex, 0, linex, 1e5)
...
def main():         
    ...
    for r in regions:
        ...
        for h in hists:
            if h.startswith('ElecTruthMatchW1/') or h.startswith('MuonTruthMatchW1/') or h.startswith('TauTruthMatchW1/') or h.startswith('RecTauOLElec1/'):

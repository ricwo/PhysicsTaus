...
void plotEff(){
  ...
  if( aT ){
    ...
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/At_semilep");
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/At_semilep");
    int rebinval = 10;
    //    TGaxis::SetMaxDigits(3); 
    h->SetTitle("Reconstructed a_{T} distributions");
    ...
    hc->GetXaxis()->SetRangeUser(0.,60.0e3);
    ...
    h10->GetXaxis()->SetRangeUser(0.,60.0e3);
    ...
    //save plot
    if (saveplots){
      c102->SaveAs("plots/20161013/ttbar/semilep/At_cumulative_Ztautau_vs_ttbar.pdf");
    }    
  }
  ...
  if( sintheta ){
    ...
    hist_leg->SetTextFont(62);
    hist_leg->SetBorderSize(0);
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/Sin_theta_semilep");
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Sin_theta_semilep");
    int rebinval = 10;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c101->SaveAs("plots/20161013/ttbar/semilep/Sin_theta_cumulative_Ztautau_vs_ttbar.pdf");
    }    
  }
  ...
  if( eta ){
    ...
    hist_leg->SetTextFont(62);
    hist_leg->SetBorderSize(0);
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/Eta_abs_semilep_lep");
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Eta_abs_semilep_lep");
    int rebinval = 10;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c99->SaveAs("plots/20161013/ttbar/semilep/Eta_l_cumulative_Ztautau_vs_ttbar.pdf");
    }    
  }
  ...
  if( pt ){
    ...
    hist_leg->SetTextFont(62);
    hist_leg->SetBorderSize(0);
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/Pt_semilep_lep");
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Pt_semilep_lep");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c98->SaveAs("plots/20161013/ttbar/semilep/Pt_l_cumulative_Ztautau_vs_ttbar_h.pdf");
    }    
  }
  ...
  if( phistar ){
    ...
    //save plot
    if (saveplots){
      c96->SaveAs("plots/20161013/ttbar/semilep/PhiStar_cumulative_Ztautau_vs_ttbar.pdf");
    }    
  }
  ...
  if( phiacop ){
    ...
    hist_leg->SetTextFont(62);
    hist_leg->SetBorderSize(0);
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/Phi_acop_semilep");
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Phi_acop_semilep");
    int rebinval = 10;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c97->SaveAs("plots/20161013/ttbar/semilep/PhiAcop_cumulative_Ztautau_vs_ttbar.pdf");
    }    
  }
  ...
  if(  eff ){
    ...
    gStyle->SetTitleX(0.5);
    gStyle->SetTitleAlign(23);
    hist_leg1 = new TLegend(0.86,0.68,1,0.95);
    ...
    dt->SetMarkerSize(.8);
    dt2->SetMarkerSize(.8);
    dt->SetMarkerColorAlpha(1,.8);
    dt2->SetMarkerColorAlpha(2,.8);
    dt->SetLineWidth(1);
    dt2->SetLineWidth(1);
    dt3->SetLineWidth(2);
    dt4->SetLineWidth(2);
    ...
    dt5->SetLineColor(8);
    dt6->SetLineColor(40);
    hist_leg1->AddEntry(dt, Form("#phi^{*}_{#eta}"), "LP");
    hist_leg1->AddEntry(dt2, Form("#phi_{acop}"),"LP");
    ...
    Tl.SetTextAlign(12);
    Tl.SetTextSize(0.03);
    Tl.DrawLatexNDC(0.2,0.82,"Z#rightarrow#tau_{h}#tau_{l} (sig) vs t#bar{t}#rightarrow#tau_{h}#tau_{l} (bkg)");

    //save plot
    if (saveplots){
      c20->SaveAs("plots/20161013/ttbar/semilep/Eff_l_Ztautau_vs_ttbar.pdf");
    }    

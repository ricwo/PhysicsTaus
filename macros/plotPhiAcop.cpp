...
void plotPhiAcop(){
  ...
  if (phitruth){
    ...
    hist_leg = new TLegend(0.60,0.62,0.80,0.82);
    ...
    TLine *l = new TLine(.4971,0,.4971,2);
    l->SetLineStyle(2);
    ...
    Tl1.DrawLatexNDC(0.82,0.093,"#pi");

    //save plot
    if (saveplots){
      c9->SaveAs("plots/20161005/PhiAcop_Ztautau_vs_ttbar.pdf");
    }    
  }

...
void plotCorrelationsBSMH700HadHad(){
  ...
  if (Phi_M){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342321/plotEventAlgs/taus/Phi_M_fraction_had_had");
  ...
  if (DPhi_pt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342321/plotEventAlgs/taus/DPhi_pT_fraction_had_had");
  ...
  if (M_pt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342321/plotEventAlgs/taus/M_fraction_pT_fraction_had_had");
  ...
  if (Pt_frac_vs){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342321/plotEventAlgs/taus/Pt_fraction_had_had");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("p_{T}^{#tau_{+/-had}^{obs.}} / p_{T}^{#tau^{truth}_{+/-had}} vs. p_{T}^{#tau_{+/-had}^{obs.}} / p_{T}^{#tau^{truth}_{+/-had}}");
    Phi_M->GetZaxis()->SetTitle("Events / 0.0004");
    Phi_M->GetXaxis()->SetTitle("p_{T}^{+/-h^{obs}} / p_{T}^{#tau^{truth}_{+/-h}}");

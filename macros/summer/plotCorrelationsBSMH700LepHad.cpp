...
void plotCorrelationsBSMH700LepHad(){

  TFile *ftautau = new TFile("H700_tautau_lh.root");
  ...
  if (dphi_2D){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342320/plotEventAlgs/taus/DPhi_2D_lep_had");
    ...
    Tl.SetTextAlign(12);
    Tl.SetTextSize(0.03);
    Tl.DrawLatexNDC(0.15,0.85,"Powheg+Pythia8+EvtGen H(700)#rightarrow#tau#tau#rightarrowlh");
    Tl.DrawLatexNDC(0.15,0.8,Form("Correlation factor %f", Phi_M->GetCorrelationFactor()));

    //save plot
    if (saveplots){
      c11->SaveAs("plots/20160711/semileptonic/H700/DPhi_2D_lep_had.pdf");
    }
  ...
  if (Phi_M){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342320/plotEventAlgs/taus/Phi_M_fraction_lep_had");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("#phi^{*#tau_{lep}#tau_{had}}_{#eta} vs. m^{obs.}_{#tau_{lep}#tau_{had}} / m^{MC}_{#tau#tau}");
    Phi_M->GetXaxis()->SetTitle("m^{obs.}_{lh} / m^{MC}_{#tau#tau}");
    Phi_M->GetYaxis()->SetTitle("log_{10}#phi^{*lh}_{#eta}");
    ...
    //save plot
    if (saveplots){
      c0->SaveAs("plots/20160711/semileptonic/H700/Phi_M_fraction_lep_had.pdf");
    }
  ...
  if (Phi_M_alt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342320/plotEventAlgs/taus/Phi_M_fraction_alt_lep_had");
    ...
    //save plot
    if (saveplots){
      c10->SaveAs("plots/20160711/semileptonic/H700/Phi_M_fraction_alt_lep_had.pdf");
    }
  ...
  if (Phi_Mt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342320/plotEventAlgs/taus/Phi_Mt_fraction_lep_had");
  ...
  if (Phi_pT){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342320/plotEventAlgs/taus/Phi_star_pT_fraction_lep_had");
  ...
  if (DPhi_M){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342320/plotEventAlgs/taus/DPhi_M_fraction_lep_had");
  ...
  if (DPhi_pt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342320/plotEventAlgs/taus/DPhi_pT_fraction_lep_lep_had");
    ...
    Phi_M->GetXaxis()->SetTitle("p_{T}^{l^{obs}} / p_{T}^{#tau_{truth}}");/*m^{obs.}_{ll} [GeV/c^{2}]*/
    ...
    //save plot
    if (saveplots){
      c20->SaveAs("plots/20160711/semileptonic/H700/DPhi_pT_fraction_lep_lep_had.pdf");
    }
  }
  ...
  if (DPhi_pt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342320/plotEventAlgs/taus/DPhi_pT_fraction_had_lep_had");
    ...
    c21->SetLeftMargin(0.14);
    c21->SetBottomMargin(0.14);
    //c21->SetLogx();
    Phi_M->Draw("COLZ");
    //hist_leg->Draw("same");
    ...
    //save plot
    if (saveplots){
      c21->SaveAs("plots/20160711/semileptonic/H700/DPhi_pT_fraction_had_lep_had.pdf");
    }
  }
  ...
  if (DPhi_pt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342320/plotEventAlgs/taus/DPhi_pT_fraction_lep_had");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("#Delta#phi_{#tau_{lep,had}^{obs.}#tau^{truth}} vs. p_{T}^{#tau_{lep,had}^{obs.}} / p_{T}^{#tau_{truth}}");
    //Phi_M->GetZaxis()->SetTitle("Events / 0.00001");
    Phi_M->GetYaxis()->SetTitle("log_{10}#Delta#phi_{l,h^{obs.}#tau^{truth}}");
    Phi_M->GetXaxis()->SetTitle("p_{T}^{l,h^{obs.}} / p_{T}^{#tau_{truth}}");/*m^{obs.}_{ll} [GeV/c^{2}]*/
    //    Phi_M->GetZaxis()->SetTitle("Events / (0.0001*log_{10}(#phi^{*#tau_{lep}#tau_{lep}}_{#eta}))");
    Phi_M->GetXaxis()->SetTitleSize(0.07);
    Phi_M->GetYaxis()->SetTitleSize(0.07);
    Phi_M->GetXaxis()->SetTitleOffset(0.8);
    ...
    //save plot
    if (saveplots){
      c2->SaveAs("plots/20160711/semileptonic/H700/DPhi_pT_fraction_lep_had.pdf");
    }
  }
  ...
  if (M_pt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342320/plotEventAlgs/taus/M_fraction_pT_fraction_lep_had");
    ...
    Tl.SetTextAlign(12);
    Tl.SetTextSize(0.03);
    Tl.DrawLatexNDC(0.15,0.88,"Powheg+Pythia8+EvtGen H(700)#rightarrow#tau#tau#rightarrowlh");
    Tl.DrawLatexNDC(0.15,0.83,Form("Correlation factor %f", Phi_M->GetCorrelationFactor()));

    //save plot
    if (saveplots){
      c5->SaveAs("plots/20160711/semileptonic/H700/M_fraction_pT_fraction_lep_had.pdf");
    }
  ...
  if (M_pt1){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342320/plotEventAlgs/taus/M_fraction_pT_fraction_lep_lep_had");
    ...
    //save plot
    if (saveplots){
      c12->SaveAs("plots/20160711/semileptonic/H700/M_fraction_pT_fraction_lep_lep_had.pdf");
    }
  ...
  if (M_pt2){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342320/plotEventAlgs/taus/M_fraction_pT_fraction_had_lep_had");
    ...
    //save plot
    if (saveplots){
      c13->SaveAs("plots/20160711/semileptonic/H700/M_fraction_pT_fraction_had_lep_had.pdf");
    }
  ...
  if (Pt_frac){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342320/plotEventAlgs/taus/Pt_fraction_lep_had");
    ...
    //save plot
    if (saveplots){
      c4->SaveAs("plots/20160711/semileptonic/H700/Pt_fraction_lep_had.pdf");
    }
  ...
  if (Pt_frac_vs){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342320/plotEventAlgs/taus/Pt_fraction_lep_vs_had");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("p_{T}^{#tau_{+/-had}^{obs.}} / p_{T}^{#tau^{truth}_{+/-had}} vs. p_{T}^{#tau_{+/-lep}^{obs.}} / p_{T}^{#tau^{truth}_{+/-lep}}");
    Phi_M->GetZaxis()->SetTitle("Events / 0.0004");
    Phi_M->GetXaxis()->SetTitle("p_{T}^{+/-l^{obs}} / p_{T}^{#tau^{truth}_{+/-l}}");
    Phi_M->GetYaxis()->SetTitle("p_{T}^{+/-h^{obs}} / p_{T}^{#tau^{truth}_{+/-h}}");
    Phi_M->GetXaxis()->SetTitleSize(0.07);
    Phi_M->GetYaxis()->SetTitleSize(0.07);
    Phi_M->GetXaxis()->SetTitleOffset(0.8);
    Phi_M->GetYaxis()->SetTitleOffset(0.8);
    ...
    //save plot
    if (saveplots){
      c9->SaveAs("plots/20160711/semileptonic/H700/Pt_fraction_lep_vs_had.pdf");
    }
  ...
  if (DPhi_phi){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342320/plotEventAlgs/taus/DPhi_Phi_star_lep_had");
  ...
  if (Mratio){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("342320/plotEventAlgs/Phi_M");

...
void plotCorrelationsLepHad(){
  ...
  if (dphi_2D){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/DPhi_2D_lep_had");
    ...
    //save plot
    if (saveplots){
      c11->SaveAs("plots/20160711/semileptonic/Z0/DPhi_2D_lep_had.pdf");
    }
  ...
  if (Phi_M){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/Phi_M_fraction_lep_had");
    ...
    //save plot
    if (saveplots){
      c0->SaveAs("plots/20160711/semileptonic/Z0/Phi_M_fraction_lep_had.pdf");
    }
  ...
  if (Phi_M_alt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/Phi_M_fraction_alt_lep_had");
    ...
    //save plot
    if (saveplots){
      c10->SaveAs("plots/20160711/semileptonic/Z0/Phi_M_fraction_alt_lep_had.pdf");
    }
  ...
  if (Phi_Mt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/Phi_Mt_fraction_lep_had");
  ...
  if (Phi_pT){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/Phi_star_pT_fraction_lep_had");
  ...
  if (DPhi_M){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/DPhi_M_fraction_lep_had");
  ...
  if (DPhi_pt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/DPhi_pT_fraction_lep_had");
    ...
    Phi_M->GetYaxis()->SetTitle("log_{10}#Delta#phi_{#tau_{l,h}^{obs.}#tau^{truth}}");
    ...
    //save plot
    if (saveplots){
      c2->SaveAs("plots/20160711/semileptonic/Z0/DPhi_pT_fraction_lep_had.pdf");
    }
  ...
  if (M_pt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/M_fraction_pT_fraction_lep_had");
    ...
    //save plot
    if (saveplots){
      c5->SaveAs("plots/20160711/semileptonic/Z0/M_fraction_pT_fraction_lep_had.pdf");
    }
  ...
  if (M_pt1){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/M_fraction_pT_fraction_lep_lep_had");
    ...
    //save plot
    if (saveplots){
      c12->SaveAs("plots/20160711/semileptonic/Z0/M_fraction_pT_fraction_lep_lep_had.pdf");
    }
  ...
  if (M_pt2){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/M_fraction_pT_fraction_had_lep_had");
    ...
    //save plot
    if (saveplots){
      c13->SaveAs("plots/20160711/semileptonic/Z0/M_fraction_pT_fraction_had_lep_had.pdf");
    }
  ...
  if (Pt_frac){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/Pt_fraction_lep_had");
    ...
    //save plot
    if (saveplots){
      c4->SaveAs("plots/20160711/semileptonic/Z0/Pt_fraction_lep_had.pdf");
    }
  ...
  if (Pt_frac_vs){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/Pt_fraction_lep_vs_had");
    ...
    Phi_M->GetYaxis()->SetTitleSize(0.07);
    Phi_M->GetXaxis()->SetTitleOffset(0.8);
    Phi_M->GetYaxis()->SetTitleOffset(.8);
    Phi_M->Rebin2D(2,2);
    Phi_M->GetXaxis()->SetRangeUser(0.,1.3);
    Phi_M->GetYaxis()->SetRangeUser(0.,1.8);
    //    c9->SetLogz();
    ...
    //save plot
    if (saveplots){
      c9->SaveAs("plots/20160711/semileptonic/Z0/Pt_fraction_lep_vs_had.pdf");
    }
  ...
  if (DPhi_phi){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/DPhi_Phi_star_lep_had");

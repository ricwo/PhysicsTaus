...
void plotCorrelationsBSMLepHad(){
  ...
  if (dphi_2D){
    ...
    //save plot
    if (saveplots){
      c11->SaveAs("plots/20160708/semileptonic/DPhi_2D_lep_had.pdf");
    }
  ...
  if (Phi_M){
    ...
    Tl.SetTextAlign(12);
    Tl.SetTextSize(0.03);
    Tl.DrawLatexNDC(0.50,0.85,"Madgraph+Pythia8 Z/#gamma^{*}#rightarrow#tau#tau, lh final state");
    Tl.DrawLatexNDC(0.50,0.8,Form("Correlation factor %f", Phi_M->GetCorrelationFactor()));

    //save plot
    if (saveplots){
      c0->SaveAs("plots/20160708/semileptonic/Phi_M_fraction_lep_had.pdf");
    }
  ...
  if (Phi_M_alt){
    ...
    //save plot
    if (saveplots){
      c10->SaveAs("plots/20160708/semileptonic/Phi_M_fraction_alt_lep_had.pdf");
    }
  ...
  if (DPhi_pt){
    ...
    //save plot
    if (saveplots){
      c2->SaveAs("plots/20160708/semileptonic/DPhi_pT_fraction_lep_had.pdf");
    }
  ...
  if (M_pt){
    ...
    Tl.SetTextAlign(12);
    Tl.SetTextSize(0.03);
    Tl.DrawLatexNDC(0.15,0.88,"Madgraph+Pythia8 Z/#gamma^{*}#rightarrow#tau#tau, lh final state");
    Tl.DrawLatexNDC(0.15,0.83,Form("Correlation factor %f", Phi_M->GetCorrelationFactor()));

    //save plot
    if (saveplots){
      c5->SaveAs("plots/20160708/semileptonic/M_fraction_pT_fraction_lep_had.pdf");
    }
  ...
  if (M_pt1){
    ...
    //save plot
    if (saveplots){
      c12->SaveAs("plots/20160708/semileptonic/M_fraction_pT_fraction_lep_lep_had.pdf");
    }
  ...
  if (M_pt2){
    ...
    //save plot
    if (saveplots){
      c13->SaveAs("plots/20160708/semileptonic/M_fraction_pT_fraction_had_lep_had.pdf");
    }
  ...
  if (Pt_frac){
    ...
    //save plot
    if (saveplots){
      c4->SaveAs("plots/20160708/semileptonic/Pt_fraction_lep_had.pdf");
    }
  ...
  if (Pt_frac_vs){
    ...
    Tl.SetTextAlign(12);
    Tl.SetTextSize(0.03);
    Tl.DrawLatexNDC(0.45,0.85,"Madgraph+Pythia8 Z/#gamma^{*}#rightarrow#tau#tau, lh final state");
    Tl.DrawLatexNDC(0.45,0.8,Form("Correlation factor %f", Phi_M->GetCorrelationFactor()));

    //save plot
    if (saveplots){
      c9->SaveAs("plots/20160708/semileptonic/Pt_fraction_lep_vs_had.pdf");
    }

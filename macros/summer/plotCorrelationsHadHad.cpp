...
void plotCorrelationsHadHad(){
  ...
  if (dphi_2D){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/DPhi_2D_had_had");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("#Delta#phi_{h^{-}_{obs}#tau^{-}_{truth}} vs. #Delta#phi_{h^{+}_{obs}#tau^{+}_{truth}}");
    Phi_M->GetXaxis()->SetTitle("log_{10}#Delta#phi_{h^{+}_{obs}#tau^{+}_{truth}}");
    Phi_M->GetYaxis()->SetTitle("log_{10}#Delta#phi_{h^{-}_{obs}#tau^{-}_{truth}}");
    ...
    //save plot
    if (saveplots){
      c11->SaveAs("plots/20160711/di-hadronic/Z0/DPhi_2D_had_had.pdf");
    }
  ...
  if (Phi_M_sub){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/Phi_M_fraction_sub_lep_had");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("#phi^{*#tau_{lep}#tau_{had}}_{#eta} vs. m^{obs}_{l,h} / m^{MC}_{#tau#tau}, #Phi^{*}_{#eta}<#Delta#Phi");
    Phi_M->GetXaxis()->SetTitle("m^{obs}_{l,h} / m^{MC}_{#tau#tau}");
    ...
    //c28->SetLogy();
    c28->SetLogz();
    c28->SetRightMargin(0.15);
    c28->SetLeftMargin(0.14);
    c28->SetBottomMargin(0.14);
    //c28->SetLogx();
    Phi_M->Draw("COLZ");
    //hist_leg->Draw("same");
    ...
    //save plot
    if (saveplots){
      c28->SaveAs("plots/20160711/semileptonic/Z0/Phi_M_fraction_sub_lep_had.pdf");
    }
  ...
  if (Phi_M){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/Phi_M_fraction_had_had");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("#phi^{*#tau_{had}#tau_{had}}_{#eta} vs. m^{obs.}_{#tau_{had}#tau_{had}} / m^{MC}_{#tau#tau}");
    Phi_M->GetXaxis()->SetTitle("m^{obs.}_{#tau_{had}#tau_{had}} / m^{MC}_{#tau#tau}");
    Phi_M->GetYaxis()->SetTitle("log_{10}#phi^{*#tau_{had}#tau_{had}}_{#eta}");
    Phi_M->GetXaxis()->SetTitleSize(0.07);
    Phi_M->GetYaxis()->SetTitleSize(0.07);
    Phi_M->GetXaxis()->SetTitleOffset(0.8);
    Phi_M->GetYaxis()->SetTitleOffset(0.8);
    ...
    //save plot
    if (saveplots){
      c0->SaveAs("plots/20160711/di-hadronic/Z0/Phi_M_fraction_had_had.pdf");
    }
  ...
  if (Phi_M_alt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/Phi_M_fraction_alt_had_had");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("#phi^{*#tau_{had}#tau_{had}}_{#eta} vs. m^{obs.}_{#tau_{had}#tau_{had}} / m^{MC}_{#tau#tau}, #phi^{*#tau_{had}#tau_{had}}_{#eta} < #Delta#phi_{#tau_{had}^{obs.}#tau^{truth}}");
    Phi_M->GetXaxis()->SetTitle("m^{obs.}_{#tau_{had}#tau_{had}} / m^{MC}_{#tau#tau}");
    Phi_M->GetYaxis()->SetTitle("log_{10}#phi^{*#tau_{had}#tau_{had}}_{#eta}");
    Phi_M->GetXaxis()->SetTitleSize(0.04);
    Phi_M->GetYaxis()->SetTitleSize(0.06);
    ...
    //save plot
    if (saveplots){
      c10->SaveAs("plots/20160711/di-hadronic/Z0/Phi_M_fraction_alt_had_had.pdf");
    }
  ...
  if (Phi_Mt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/Phi_Mt_fraction_had_had");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("#phi^{*#tau_{had}#tau_{had}}_{#eta} vs. m^{obs.}_{T(#tau_{had}#tau_{had})} / m^{MC}_{T(#tau#tau)}");
    Phi_M->GetXaxis()->SetTitle("m^{obs.}_{T(#tau_{had}#tau_{had})} / m^{MC}_{T(#tau#tau)}");
    Phi_M->GetYaxis()->SetTitle("log_{10}#phi^{*#tau_{had}#tau_{had}}_{#eta}");
    Phi_M->GetXaxis()->SetTitleSize(0.04);
    Phi_M->GetYaxis()->SetTitleSize(0.06);
    Phi_M->GetXaxis()->SetTitleOffset(1.15);
    ...
    //save plot
    if (saveplots){
      c6->SaveAs("plots/20160621/Phi_Mt_fraction_had_had.pdf");
    }
  ...
  if (Phi_pT){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/Phi_star_pT_fraction_had_had");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("#phi^{*#tau_{had}#tau_{had}}_{#eta} vs. p_{T}^{#tau_{had},#tau_{had}^{obs.}} / p_{T}^{#tau^{truth}_{lep,had}}");
    Phi_M->GetXaxis()->SetTitle("p_{T}^{#tau_{had},#tau_{had}^{obs.}} / p_{T}^{#tau^{truth}_{lep,had}}");
    Phi_M->GetYaxis()->SetTitle("log_{10}#phi^{*#tau_{had}#tau_{had}}_{#eta}");
    Phi_M->GetXaxis()->SetTitleSize(0.04);
    Phi_M->GetYaxis()->SetTitleSize(0.06);
    Phi_M->GetXaxis()->SetTitleOffset(1.15);
    ...
    //save plot
    if (saveplots){
      c7->SaveAs("plots/20160621/Phi_pT_fraction_had_had.pdf");
    }
  }
  ...
  if (DPhi_M){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/DPhi_M_fraction_had_had");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("#Delta#phi_{#tau_{had,lep}^{obs.}#tau^{truth}_{had,lep}} vs. m^{obs.}_{T(#tau_{had}#tau_{had})} / m^{MC}_{T(#tau#tau)}");
    Phi_M->GetXaxis()->SetTitle("m^{obs.}_{T(#tau_{had}#tau_{had})} / m^{MC}_{T(#tau#tau)}");
    ...
    //save plot
    if (saveplots){
      c8->SaveAs("plots/20160621/DPhi_M_fraction_had_had.pdf");
    }
  ...
  if (DPhi_pt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/DPhi_pT_fraction_had_had");
    ...
    //    Phi_M->GetZaxis()->SetTitle("Events / (0.0001*log_{10}(#phi^{*#tau_{had}#tau_{had}}_{#eta}))");
    Phi_M->GetXaxis()->SetTitleSize(0.07);
    Phi_M->GetYaxis()->SetTitleSize(0.07);
    Phi_M->GetXaxis()->SetTitleOffset(0.8);
    Phi_M->GetYaxis()->SetTitleOffset(0.8);
    ...
    //save plot
    if (saveplots){
      c2->SaveAs("plots/20160711/di-hadronic/Z0/DPhi_pT_fraction_had_had.pdf");
    }
  ...
  if (M_pt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/M_fraction_pT_fraction_had_had");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("p_{T}^{#tau_{had}^{obs. (1,2)}} / p_{T}^{#tau^{truth (1,2)}} vs. m^{obs.}_{#tau_{had}#tau_{had}} / m^{MC}_{#tau#tau}");
    Phi_M->GetZaxis()->SetTitle("Events / 0.0004");
    Phi_M->GetXaxis()->SetTitle("m^{obs.}_{#tau_{had}#tau_{had}} / m^{MC}_{#tau#tau}");
    Phi_M->GetYaxis()->SetTitle("p_{T}^{#tau_{had}}^{obs. (1,2)} / p_{T}^{#tau^{truth (1,2)}}");
    Phi_M->GetXaxis()->SetTitleSize(0.04);
    Phi_M->GetYaxis()->SetTitleSize(0.06);
    Phi_M->GetXaxis()->SetTitleOffset(1.15);
    Phi_M->GetYaxis()->SetTitleOffset(1.);
    Phi_M->Rebin2D(2,2);
    Phi_M->GetXaxis()->SetRangeUser(0.,1.6);
    Phi_M->GetYaxis()->SetRangeUser(0.,1.6);
    c5->SetLogz();
    ...
    Tl.SetTextAlign(12);
    Tl.SetTextSize(0.03);
    Tl.DrawLatexNDC(0.15,0.88,"Madgraph+Pythia8 Z/#gamma^{*}#rightarrow#tau#tau, hh final state");
    Tl.DrawLatexNDC(0.15,0.83,Form("Correlation factor %f", Phi_M->GetCorrelationFactor()));

    //save plot
    if (saveplots){
      c5->SaveAs("plots/20160711/di-hadronic/Z0/M_fraction_pT_fraction_had_had.pdf");
    }
  ...
  if (Pt_frac){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/Pt_fraction_had_had");
    ...
    //save plot
    if (saveplots){
      c4->SaveAs("plots/20160711/di-hadronic/Z0/Pt_fraction_had_had.pdf");
    }
  ...
  if (DPhi_phi){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/DPhi_Phi_star_had_had");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("#phi^{*#tau_{had}#tau_{had}}_{#eta} vs. #Delta#phi_{#tau_{had,lep}^{obs.}#tau^{truth}_{had,lep}}");
    //Phi_M->GetZaxis()->SetTitle("Events / 0.00001");
    Phi_M->GetXaxis()->SetTitle("log_{10}#Delta#phi_{#tau_{had,lep}^{obs.}#tau^{truth}_{had,lep}}");
    Phi_M->GetYaxis()->SetTitle("log_{10}#phi^{*#tau_{had}#tau_{had}}_{#eta}");/*m^{obs.}_{ll} [GeV/c^{2}]*/
    //    Phi_M->GetZaxis()->SetTitle("Events / (0.0001*log_{10}(#phi^{*#tau_{had}#tau_{had}}_{#eta}))");
    Phi_M->GetXaxis()->SetTitleSize(0.04);
    Phi_M->GetYaxis()->SetTitleSize(0.06);
    Phi_M->GetXaxis()->SetTitleOffset(1.15);
    ...
    //save plot
    if (saveplots){
      c3->SaveAs("plots/20160621/DPhi_phi_star_had_had.pdf");
    }

...
void plotAngularDistLepHad(){
  ...
  if (angular){
    ...
    TH1F *Phi_M		= (TH1F*)ftautau->Get("361510/plotEventAlgs/taus/DPhi_tau_lep_had");
    TH1F *Phi_M1       	= (TH1F*)ftautau->Get("361510/plotEventAlgs/taus/Phi_acop_lep_had_tau_tau");
    TH1F *Phi_M2       	= (TH1F*)ftautau->Get("361510/plotEventAlgs/taus/Phi_acop_lep_had");
    ...
    //save plot
    if (saveplots){
      c0->SaveAs("plots/20160623/semileptonic/Angular_dists_lep_had.pdf");
    }    
  }
  ...
  if (starred){
    ...
    TH1F *Phi_M		= (TH1F*)ftautau->Get("361510/plotEventAlgs/taus/DPhi_sin_theta_truth_reco_lep_had");
    TH1F *Phi_M1       	= (TH1F*)ftautau->Get("361510/plotEventAlgs/taus/Phi_truth_lep_had");
    TH1F *Phi_M2       	= (TH1F*)ftautau->Get("361510/plotEventAlgs/taus/Phi_reco_lep_had");
    ...
    //save plot
    if (saveplots){
      c1->SaveAs("plots/20160623/semileptonic/Angular_dists_starred_lep_had.pdf");
    }    
  }

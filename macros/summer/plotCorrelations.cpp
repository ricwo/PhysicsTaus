...
void plotCorrelations(){
  ...
  if (Phi_M){
    ...
    Phi_M->SetTitle("#phi^{*#mu#tau_{had}}_{#eta} vs. m^{obs.}_{#mu#tau_{had}} / m^{MC}_{#tau#tau}");
    Phi_M->GetXaxis()->SetTitle("m^{obs.}_{#mu#tau_{had}} / m^{MC}_{#tau#tau}");
    Phi_M->GetYaxis()->SetTitle("log_{10}#phi^{*#mu#tau_{had}}_{#eta}");
    ...
    //save plot
    if (saveplots){
      c0->SaveAs("plots/20160621/Phi_M_fraction_mu_had.pdf");
    }
  ...
  if (Phi_Mt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/Phi_Mt_fraction_mu_tau");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("#phi^{*#mu#tau_{had}}_{#eta} vs. m^{obs.}_{T(#mu#tau_{had})} / m^{MC}_{T(#tau#tau)}");
    Phi_M->GetXaxis()->SetTitle("m^{obs.}_{T(#mu#tau_{had})} / m^{MC}_{T(#tau#tau)}");
    Phi_M->GetYaxis()->SetTitle("log_{10}#phi^{*#mu#tau_{had}}_{#eta}");
    Phi_M->GetXaxis()->SetTitleSize(0.04);
    Phi_M->GetYaxis()->SetTitleSize(0.06);
    Phi_M->GetXaxis()->SetTitleOffset(1.15);
    ...
    //save plot
    if (saveplots){
      c6->SaveAs("plots/20160621/Phi_Mt_fraction_mu_had.pdf");
    }
  ...
  if (Phi_pT){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/Phi_star_pT_fraction_mu_had");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("#phi^{*#mu#tau_{had}}_{#eta} vs. p_{T}^{#mu,#tau_{had}^{obs.}} / p_{T}^{#tau^{truth}_{lep,had}}");
    Phi_M->GetXaxis()->SetTitle("p_{T}^{#mu,#tau_{had}^{obs.}} / p_{T}^{#tau^{truth}_{lep,had}}");
    Phi_M->GetYaxis()->SetTitle("log_{10}#phi^{*#mu#tau_{had}}_{#eta}");
    Phi_M->GetXaxis()->SetTitleSize(0.04);
    Phi_M->GetYaxis()->SetTitleSize(0.06);
    Phi_M->GetXaxis()->SetTitleOffset(1.15);
    ...
    //save plot
    if (saveplots){
      c7->SaveAs("plots/20160621/Phi_pT_fraction_mu_had.pdf");
    }
  }
  ...
  if (DPhi_M){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/DPhi_M_fraction_mu_had");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("#Delta#phi_{#tau_{had,lep}^{obs.}#tau^{truth}_{had,lep}} vs. m^{obs.}_{T(#mu#tau_{had})} / m^{MC}_{T(#tau#tau)}");
    Phi_M->GetXaxis()->SetTitle("m^{obs.}_{T(#mu#tau_{had})} / m^{MC}_{T(#tau#tau)}");
    ...
    //save plot
    if (saveplots){
      c8->SaveAs("plots/20160621/DPhi_M_fraction_mu_had.pdf");
    }
  ...
  if (DPhi_pt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/DPhi_pT_fraction_mu_tau");
    ...
    //    Phi_M->GetZaxis()->SetTitle("Events / (0.0001*log_{10}(#phi^{*#mu#tau_{had}}_{#eta}))");
    Phi_M->GetXaxis()->SetTitleSize(0.04);
    Phi_M->GetYaxis()->SetTitleSize(0.06);
    Phi_M->GetXaxis()->SetTitleOffset(1.15);
    Phi_M->GetYaxis()->SetTitleOffset(1.);
    ...
    //save plot
    if (saveplots){
      c2->SaveAs("plots/20160621/DPhi_pT_fraction_mu_had.pdf");
    }
  ...
  if (M_pt){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/M_fraction_pT_fraction_mu_had");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("p_{T}^{#mu,#tau_{had}^{obs.}} / p_{T}^{#tau^{truth}_{lep,had}} vs. m^{obs.}_{#mu#tau_{had}} / m^{MC}_{#tau#tau}");
    Phi_M->GetZaxis()->SetTitle("Events / 0.00004");
    Phi_M->GetXaxis()->SetTitle("m^{obs.}_{#mu#tau_{had}} / m^{MC}_{#tau#tau}");
    Phi_M->GetYaxis()->SetTitle("p_{T}^{#mu,#tau_{had}^{obs.}} / p_{T}^{#tau^{truth}_{lep,had}}");
    Phi_M->GetXaxis()->SetTitleSize(0.04);
    Phi_M->GetYaxis()->SetTitleSize(0.06);
    Phi_M->GetXaxis()->SetTitleOffset(1.15);
    Phi_M->GetYaxis()->SetTitleOffset(1.);
    ...
    Tl.SetTextAlign(12);
    Tl.SetTextSize(0.03);
    Tl.DrawLatexNDC(0.15,0.88,"Madgraph+Pythia8 Z/#gamma^{*}#rightarrow#tau#tau, #muh final state");
    Tl.DrawLatexNDC(0.15,0.83,Form("Correlation factor %f", Phi_M->GetCorrelationFactor()));

    //save plot
    if (saveplots){
      c5->SaveAs("plots/20160621/M_fraction_pT_fraction_mu_had.pdf");
    }
  ...
  if (Pt_frac){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/Pt_fraction_mu_had");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("p_{T}^{#mu^{obs.}} / p_{T}^{#tau^{truth}_{lep}} vs. p_{T}^{#tau_{had}^{obs.}} / p_{T}^{#tau^{truth}_{had}}");
    Phi_M->GetZaxis()->SetTitle("Events / 0.00004");
    Phi_M->GetXaxis()->SetTitle("p_{T}^{#tau_{had}^{obs.}} / p_{T}^{#tau^{truth}_{had}}");
    Phi_M->GetYaxis()->SetTitle("p_{T}^{#mu^{obs.}} / p_{T}^{#tau^{truth}_{lep}}");
    Phi_M->GetXaxis()->SetTitleSize(0.04);
    Phi_M->GetYaxis()->SetTitleSize(0.06);
    Phi_M->GetXaxis()->SetTitleOffset(1.15);
    Phi_M->GetYaxis()->SetTitleOffset(1.);
    ...
    //save plot
    if (saveplots){
      c4->SaveAs("plots/20160621/Pt_fraction_mu_had.pdf");
    }
  ...
  if (DPhi_phi){
    ...
    TH2F *Phi_M		= (TH2F*)ftautau->Get("361510/plotEventAlgs/taus/DPhi_Phi_star_mu_tau");

    int   NentriesPhiM	= (Phi_M->GetEntries());

    Phi_M->SetTitle("#phi^{*#mu#tau_{had}}_{#eta} vs. #Delta#phi_{#tau_{had,lep}^{obs.}#tau^{truth}_{had,lep}}");
    //Phi_M->GetZaxis()->SetTitle("Events / 0.00001");
    ...
    //save plot
    if (saveplots){
      c3->SaveAs("plots/20160621/DPhi_phi_star_mu_had.pdf");
    }

...
void plotCorrelationsBSMZ3000LepHad(){
  ...
  if (dphi_2D){
    ...
    Tl.SetTextAlign(12);
    Tl.SetTextSize(0.03);
    Tl.DrawLatexNDC(0.15,0.85,"Pythia8+EvtGen Z'(3000)#rightarrow#tau#tau, lh final state");
    Tl.DrawLatexNDC(0.15,0.8,Form("Correlation factor %f", Phi_M->GetCorrelationFactor()));

    //save plot
    if (saveplots){
      c11->SaveAs("plots/20160711/semileptonic/Z3000/DPhi_2D_lep_had.pdf");
    }
  ...
  if (Phi_M){
    ...
    Phi_M->GetYaxis()->SetTitle("log_{10}#phi^{*l,h}_{#eta}");
    ...
    //save plot
    if (saveplots){
      c0->SaveAs("plots/20160711/semileptonic/Z3000/Phi_M_fraction_lep_had.pdf");
    }
  ...
  if (Phi_M_alt){
    ...
    //save plot
    if (saveplots){
      c10->SaveAs("plots/20160711/semileptonic/Z3000/Phi_M_fraction_alt_lep_had.pdf");
    }
  ...
  if (DPhi_pt){
    ...
    //save plot
    if (saveplots){
      c21->SaveAs("plots/20160711/semileptonic/Z3000/DPhi_pT_fraction_lep_lep_had.pdf");
    }
  ...
  if (DPhi_pt){
    ...
    //save plot
    if (saveplots){
      c20->SaveAs("plots/20160711/semileptonic/Z3000/DPhi_pT_fraction_had_lep_had.pdf");
    }
  ...
  if (DPhi_pt){
    ...
    //save plot
    if (saveplots){
      c2->SaveAs("plots/20160711/semileptonic/Z3000/DPhi_pT_fraction_lep_had.pdf");
    }
  ...
  if (M_pt){
    ...
    Tl.SetTextAlign(12);
    Tl.SetTextSize(0.03);
    Tl.DrawLatexNDC(0.15,0.88,"Pythia8+EvtGen Z'(3000)#rightarrow#tau#tau, lh final state");
    Tl.DrawLatexNDC(0.15,0.83,Form("Correlation factor %f", Phi_M->GetCorrelationFactor()));

    //save plot
    if (saveplots){
      c5->SaveAs("plots/20160711/semileptonic/Z3000/M_fraction_pT_fraction_lep_had.pdf");
    }
  ...
  if (M_pt1){
    ...
    //save plot
    if (saveplots){
      c12->SaveAs("plots/20160711/semileptonic/Z3000/M_fraction_pT_fraction_lep_lep_had.pdf");
    }
  ...
  if (M_pt2){
    ...
    //save plot
    if (saveplots){
      c13->SaveAs("plots/20160711/semileptonic/Z3000/M_fraction_pT_fraction_had_lep_had.pdf");
    }
  ...
  if (Pt_frac){
    ...
    //save plot
    if (saveplots){
      c4->SaveAs("plots/20160711/semileptonic/Z3000/Pt_fraction_lep_had.pdf");
    }
  ...
  if (Pt_frac_vs){
    ...
    //save plot
    if (saveplots){
      c9->SaveAs("plots/20160711/semileptonic/Z3000/Pt_fraction_lep_vs_had.pdf");
    }

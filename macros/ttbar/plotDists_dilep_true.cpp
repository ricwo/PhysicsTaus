...
void plotDists_dilep_true(){
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c1->SaveAs("plots/20161016/ttbar/dilep/true/At_dilep_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c2->SaveAs("plots/20161016/ttbar/dilep/true/Pt_dilep_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c3->SaveAs("plots/20161016/ttbar/dilep/true/Eta_dilep_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c4->SaveAs("plots/20161016/ttbar/dilep/true/PhiAcop_dilep_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c5->SaveAs("plots/20161016/ttbar/dilep/true/Sin_theta_dilep_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c6->SaveAs("plots/20161016/ttbar/dilep/true/PhiStar_dilep_Ztautau_vs_ttbar_true.pdf");
    }    
  }
}

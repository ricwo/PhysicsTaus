...
void plotDists_semilep_l_true(){
  ...
  if (1==1){
    ...
    TH1F *h2		= (TH1F*)f->Get("361510/plotEventAlgs/taus/At_semilep_bkg_truth");
    ...
    //save plot
    if (saveplots){
      c1->SaveAs("plots/20161016/ttbar/semilep/At_semilep_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c2->SaveAs("plots/20161016/ttbar/semilep/Pt_semilep_l_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c3->SaveAs("plots/20161016/ttbar/semilep/Eta_semilep_l_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c4->SaveAs("plots/20161016/ttbar/semilep/PhiAcop_semilep_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c5->SaveAs("plots/20161016/ttbar/semilep/Sin_theta_semilep_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c6->SaveAs("plots/20161016/ttbar/semilep/PhiStar_semilep_Ztautau_vs_ttbar_true.pdf");
    }    
  }
}

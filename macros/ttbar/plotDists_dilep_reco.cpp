...
void plotDists_dilep_reco(){
  ...
  if (at){
    ...
    h->GetYaxis()->SetTitle("Normalised events / 1 GeV");
    ...
    h->GetYaxis()->SetRangeUser(0.,200e-6);
    ...
    //save plot
    if (saveplots){
      c1->SaveAs("plots/20161016/ttbar/dilep/reco/At_dilep_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c2->SaveAs("plots/20161016/ttbar/dilep/reco/Pt_dilep_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c3->SaveAs("plots/20161016/ttbar/dilep/reco/Eta_dilep_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c4->SaveAs("plots/20161016/ttbar/dilep/reco/PhiAcop_dilep_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c5->SaveAs("plots/20161016/ttbar/dilep/reco/Sin_theta_dilep_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c6->SaveAs("plots/20161016/ttbar/dilep/reco/PhiStar_dilep_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
}

...
void plotEff_semilep_reco(){
  ...
  if( aT ){
    ...
    //save plot
    if (saveplots){
      c102->SaveAs("plots/20161020/ttbar/semilep/reco/At_cumulative_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if( sintheta ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Sin_theta_alt_semilep_bkg");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c101->SaveAs("plots/20161020/ttbar/semilep/reco/Sin_theta_alt_cumulative_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if( eta ){
    ...
    //save plot
    if (saveplots){
      c110->SaveAs("plots/20161020/ttbar/semilep/reco/Eta_l_cumulative_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if( eta ){
    ...
    //save plot
    if (saveplots){
      c99->SaveAs("plots/20161020/ttbar/semilep/reco/Eta_h_cumulative_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if( pt ){
    ...
    //save plot
    if (saveplots){
      c98->SaveAs("plots/20161020/ttbar/semilep/reco/Pt_l_cumulative_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if( pt ){
    ...
    //save plot
    if (saveplots){
      c111->SaveAs("plots/20161020/ttbar/semilep/reco/Pt_h_cumulative_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if( phistar ){
    ...
    //save plot
    if (saveplots){
      c96->SaveAs("plots/20161020/ttbar/semilep/reco/PhiStar_cumulative_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if( phiacop ){
    ...
    //save plot
    if (saveplots){
      c97->SaveAs("plots/20161020/ttbar/semilep/reco/PhiAcop_cumulative_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if(  eff ){
    ...
    //save plot
    if (saveplots){
      c20->SaveAs("plots/20161020/ttbar/semilep/reco/Eff_lh_Ztautau_vs_ttbar_reco.pdf");
    }    

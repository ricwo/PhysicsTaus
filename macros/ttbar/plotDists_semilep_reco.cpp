...
void plotDists_semilep_reco(){
  ...
  if (at){
    ...
    h->GetYaxis()->SetRangeUser(0.,120e-6);
    ...
    //save plot
    if (saveplots){
      c1->SaveAs("plots/20161020/ttbar/semilep/reco/At_semilep_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c2->SaveAs("plots/20161020/ttbar/semilep/reco/Pt_semilep_l_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c7->SaveAs("plots/20161020/ttbar/semilep/reco/Pt_semilep_h_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if (at){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Eta_semilep_lep_bkg");
    int rebinval = 1;
    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c3->SaveAs("plots/20161020/ttbar/semilep/reco/Eta_semilep_l_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if (at){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Eta_semilep_had_bkg");
    int rebinval = 1;
    TGaxis::SetMaxDigits(3); 
    h->SetTitle("Reco #eta distributions");
    ...
    //save plot
    if (saveplots){
      c8->SaveAs("plots/20161020/ttbar/semilep/reco/Eta_semilep_h_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c4->SaveAs("plots/20161020/ttbar/semilep/reco/PhiAcop_semilep_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c5->SaveAs("plots/20161020/ttbar/semilep/reco/Sin_theta_alt_semilep_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if (at){
    ...
    h->GetYaxis()->SetRangeUser(0.,1.39);
    ...
    //save plot
    if (saveplots){
      c6->SaveAs("plots/20161020/ttbar/semilep/reco/PhiStar_semilep_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
}

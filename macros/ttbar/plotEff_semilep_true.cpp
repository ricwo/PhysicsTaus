...
void plotEff_semilep_true(){
  ...
  if( aT ){
    ...
    //save plot
    if (saveplots){
      c102->SaveAs("plots/20161016/ttbar/semilep/true/At_cumulative_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if( sintheta ){
    ...
    //save plot
    if (saveplots){
      c101->SaveAs("plots/20161016/ttbar/semilep/true/Sin_theta_cumulative_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if( eta ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Eta_abs_semilep_lep_bkg_truth");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c110->SaveAs("plots/20161016/ttbar/semilep/true/Eta_l_cumulative_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if( eta ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Eta_abs_semilep_had_bkg_truth");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    h->SetTitle("True #eta distributions");
    h->GetXaxis()->SetTitle("log_{10}#phi^{*}_{#eta}");
    ...
    //save plot
    if (saveplots){
      c99->SaveAs("plots/20161016/ttbar/semilep/true/Eta_h_cumulative_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if( pt ){
    ...
    //save plot
    if (saveplots){
      c98->SaveAs("plots/20161016/ttbar/semilep/true/Pt_l_cumulative_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if( pt ){
    ...
    //save plot
    if (saveplots){
      c111->SaveAs("plots/20161016/ttbar/semilep/true/Pt_h_cumulative_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if( phistar ){
    ...
    //save plot
    if (saveplots){
      c96->SaveAs("plots/20161016/ttbar/semilep/true/PhiStar_cumulative_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if( phiacop ){
    ...
    //save plot
    if (saveplots){
      c97->SaveAs("plots/20161016/ttbar/semilep/true/PhiAcop_cumulative_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if(  eff ){
    ...
    //save plot
    if (saveplots){
      c20->SaveAs("plots/20161016/ttbar/semilep/true/Eff_Ztautau_vs_ttbar_true.pdf");
    }    

...
void plotEff_dilep_reco(){
  ...
  if( aT ){
    ...
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/At_dilep_bkg");
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/At_dilep_bkg");
    int rebinval = 1;
    ...
    h10->GetYaxis()->SetRangeUser(.01,1.9);
    ...
    //save plot
    if (saveplots){
      c102->SaveAs("plots/20161016/ttbar/dilep/reco/At_cumulative_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if( sintheta ){
    ...
    hist_leg->SetTextFont(62);
    hist_leg->SetBorderSize(0);
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/Sin_theta_dilep_bkg");
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Sin_theta_dilep_bkg");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c101->SaveAs("plots/20161016/ttbar/dilep/reco/Sin_theta_cumulative_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if( eta ){
    ...
    hist_leg->SetTextFont(62);
    hist_leg->SetBorderSize(0);
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/Eta_abs_dilep_bkg");
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Eta_abs_dilep_bkg");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c99->SaveAs("plots/20161016/ttbar/dilep/reco/Eta_l_cumulative_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if( pt ){
    ...
    hist_leg->SetTextFont(62);
    hist_leg->SetBorderSize(0);
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/Pt_dilep_bkg");
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Pt_dilep_bkg");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    h10->GetXaxis()->SetTitle("p_{T} [MeV]");
    h10->GetYaxis()->SetTitle("Ratio Z/t#bar{t}");
    h10->GetXaxis()->SetTitleSize(0.07);
    h10->GetYaxis()->SetTitleSize(0.07);
    h10->GetXaxis()->SetTitleOffset(.2);
    ...
    h10->GetYaxis()->SetLabelFont(62); // Absolute font size in pixel (precision 3)
    h10->GetYaxis()->SetLabelSize(0.1);
    h10->GetYaxis()->SetRangeUser(0.5,6.1);
    ...
    //save plot
    if (saveplots){
      c98->SaveAs("plots/20161016/ttbar/dilep/reco/Pt_l_cumulative_Ztautau_vs_ttbar_h_reco.pdf");
    }    
  }
  ...
  if( phistar ){
    ...
    hist_leg->SetTextFont(62);
    hist_leg->SetBorderSize(0);
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/PhiStarEta_dilep_bkg");
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/PhiStarEta_dilep_bkg");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c96->SaveAs("plots/20161016/ttbar/dilep/reco/PhiStar_cumulative_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if( phiacop ){
    ...
    hist_leg->SetTextFont(62);
    hist_leg->SetBorderSize(0);
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/Phi_acop_dilep_bkg");
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Phi_acop_dilep_bkg");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c97->SaveAs("plots/20161016/ttbar/dilep/reco/PhiAcop_cumulative_Ztautau_vs_ttbar_reco.pdf");
    }    
  }
  ...
  if(  eff ){
    ...
    Tl.SetTextAlign(12);
    Tl.SetTextSize(0.03);
    //    Tl.DrawLatexNDC(0.2,0.82,"Z#rightarrow#tau_{l}#tau_{l} (sig) vs W(#rightarrow#mu#nu)+jets(#rightarrow#tau_{l}) (bkg)");
    Tl.DrawLatexNDC(0.2,0.82,"Z#rightarrow#tau_{l}#tau_{l} (sig) vs t#bar{t}#rightarrow ll (bkg)");

    //save plot
    if (saveplots){
      c20->SaveAs("plots/20161016/ttbar/dilep/reco/Eff_ll_Ztautau_vs_ttbar_reco.pdf");
    }    

...
void plotEff_dilep_true(){
  ...
  if( aT ){
    ...
    //save plot
    if (saveplots){
      c102->SaveAs("plots/20161016/ttbar/dilep/true/At_cumulative_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if( sintheta ){
    ...
    //save plot
    if (saveplots){
      c101->SaveAs("plots/20161016/ttbar/dilep/true/Sin_theta_cumulative_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if( eta ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Eta_abs_dilep_bkg_truth");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c99->SaveAs("plots/20161016/ttbar/dilep/true/Eta_l_cumulative_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if( pt ){
    ...
    //save plot
    if (saveplots){
      c98->SaveAs("plots/20161016/ttbar/dilep/true/Pt_l_cumulative_Ztautau_vs_ttbar_h_true.pdf");
    }    
  }
  ...
  if( phistar ){
    ...
    //save plot
    if (saveplots){
      c96->SaveAs("plots/20161016/ttbar/dilep/true/PhiStar_cumulative_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if( phiacop ){
    ...
    //save plot
    if (saveplots){
      c97->SaveAs("plots/20161016/ttbar/dilep/true/PhiAcop_cumulative_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if(  eff ){
    ...
    //save plot
    if (saveplots){
      c20->SaveAs("plots/20161016/ttbar/dilep/true/Eff_ll_Ztautau_vs_ttbar_true.pdf");
    }    

...
void plotDists_dilep_true(){
  ...
  TFile *f2 = new TFile("Wplumunu1M.root");
  ...
  if (at){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/At_dilep_bkg_truth");
    TH1F *h3       	= (TH1F*)f2->Get("361101/plotEventAlgs/taus/At_dilep_bkg_truth");
    int rebinval = 5;
    ...
    //save plot
    if (saveplots){
      c1->SaveAs("plots/20161016/ttbar/dilep/At_dilep_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Pt_dilep_bkg_truth");
    TH1F *h3       	= (TH1F*)f2->Get("361101/plotEventAlgs/taus/Pt_dilep_bkg_truth");
    int rebinval = 1;
    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c2->SaveAs("plots/20161016/ttbar/dilep/Pt_dilep_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Eta_dilep_bkg_truth");
    TH1F *h3       	= (TH1F*)f2->Get("361101/plotEventAlgs/taus/Eta_dilep_bkg_truth");
    int rebinval = 1;
    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c3->SaveAs("plots/20161016/ttbar/dilep/Eta_dilep_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Phi_acop_dilep_bkg_truth");
    TH1F *h3       	= (TH1F*)f2->Get("361101/plotEventAlgs/taus/Phi_acop_dilep_bkg_truth");
    int rebinval = 5;
    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c4->SaveAs("plots/20161016/ttbar/dilep/PhiAcop_dilep_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Sin_theta_dilep_bkg_truth");
    TH1F *h3       	= (TH1F*)f2->Get("361101/plotEventAlgs/taus/Sin_theta_dilep_bkg_truth");
    int rebinval = 5;
    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c5->SaveAs("plots/20161016/ttbar/dilep/Sin_theta_dilep_Ztautau_vs_ttbar_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/PhiStarEta_dilep_bkg_truth");
    TH1F *h3       	= (TH1F*)f2->Get("361101/plotEventAlgs/taus/PhiStarEta_dilep_bkg_truth");
    int rebinval = 1;
    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c6->SaveAs("plots/20161016/ttbar/dilep/PhiStar_dilep_Ztautau_vs_ttbar_true.pdf");
    }    
  }
}

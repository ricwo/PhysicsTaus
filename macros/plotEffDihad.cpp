...
void plotEffDihad(){
  ...
  if( sintheta ){
    ...
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/Sin_theta_dihad");
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Sin_theta_dihad");
    int rebinval = 10;
    ...
    hist_leg->AddEntry(h2, Form("t#bar{t}#rightarrow#tau_{h}#tau_{h}"));
    ...
    //save plot
    if (saveplots){
      c101->SaveAs("plots/20161011/dihad/Sin_theta_hh_cumulative_Ztautau_vs_ttbar.pdf");
    }    
  }
  ...
  if( eta ){
    ...
    hist_leg->SetTextFont(62);
    hist_leg->SetBorderSize(0);
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/Eta_dihad");
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Eta_dihad");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c99->SaveAs("plots/20161011/dihad/Eta_hh_cumulative_Ztautau_vs_ttbar.pdf");
    }    
  }
  ...
  if( pt ){
    ...
    hist_leg->SetTextFont(62);
    hist_leg->SetBorderSize(0);
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/Pt_dihad");
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Pt_dihad");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c98->SaveAs("plots/20161011/dihad/Pt_hh_cumulative_Ztautau_vs_ttbar_h.pdf");
    }    
  }
  ...
  if( phistar ){
    ...
    hist_leg->SetTextFont(62);
    hist_leg->SetBorderSize(0);
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/PhiStarEta_dihad");
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/PhiStarEta_dihad");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c96->SaveAs("plots/20161011/dihad/PhiStar_hh_cumulative_Ztautau_vs_ttbar.pdf");
    }    
  }
  ...
  if( phiacop ){
    ...
    hist_leg->SetTextFont(62);
    hist_leg->SetBorderSize(0);
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/Phi_acop_dihad");
    TH1F *h2       	= (TH1F*)f1->Get("410000/plotEventAlgs/taus/Phi_acop_dihad");
    int rebinval = 10;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c97->SaveAs("plots/20161011/dihad/PhiAcop_hh_cumulative_Ztautau_vs_ttbar.pdf");
    }    
  }
  ...
  if(  eff ){
    ...
    Tl.SetTextAlign(12);
    Tl.SetTextSize(0.03);
    Tl.DrawLatexNDC(0.2,0.82,"Z#rightarrow#tau_{h}#tau_{h} (sig) vs t#bar{t}#rightarrow#tau_{h}#tau_{h} (bkg)");

    //save plot
    if (saveplots){
      c20->SaveAs("plots/20161011/dihad/Eff_hh_Ztautau_vs_ttbar.pdf");
    }    

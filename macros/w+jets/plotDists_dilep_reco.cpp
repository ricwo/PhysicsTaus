...
void plotDists_dilep_reco(){
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c1->SaveAs("plots/20161016/w+jets/dilep/reco/At_dilep_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c2->SaveAs("plots/20161016/w+jets/dilep/reco/Pt_dilep_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if (at){
    ...
    gStyle->SetTitleX(0.5);
    gStyle->SetTitleAlign(23);
    hist_leg = new TLegend(0.75,0.62,0.85,0.82);
    hist_leg->SetFillColor(0);
    hist_leg->SetLineColor(1);
    hist_leg->SetShadowColor(0);
    hist_leg->SetTextSize(0.03);
    ...
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/Eta_dilep_bkg");
    int rebinval = 1;
    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c3->SaveAs("plots/20161016/w+jets/dilep/reco/Eta_dilep_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if (at){
    ...
    gStyle->SetTitleX(0.5);
    gStyle->SetTitleAlign(23);
    hist_leg = new TLegend(0.35,0.62,0.45,.82);
    hist_leg->SetFillColor(0);
    hist_leg->SetLineColor(1);
    hist_leg->SetShadowColor(0);
    hist_leg->SetTextSize(0.03);
    ...
    //save plot
    if (saveplots){
      c4->SaveAs("plots/20161016/w+jets/dilep/reco/PhiAcop_dilep_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c5->SaveAs("plots/20161016/w+jets/dilep/reco/Sin_theta_dilep_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c6->SaveAs("plots/20161016/w+jets/dilep/reco/PhiStar_dilep_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
}

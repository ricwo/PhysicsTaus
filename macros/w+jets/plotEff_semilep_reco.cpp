...
void plotEff_semilep_reco(){
  ...
  if( aT ){
    ...
    //save plot
    if (saveplots){
      c102->SaveAs("plots/20161027/w+jets/semilep/reco/At_cumulative_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if( sintheta ){
    ...
    h10->GetXaxis()->SetTitle("log_{10}(1-sin(#theta^{*}_{#eta}))");
    h10->GetYaxis()->SetTitle("Ratio Z/w+jets");
    h10->GetXaxis()->SetTitleSize(0.07);
    h10->GetYaxis()->SetTitleSize(0.07);
    h10->GetXaxis()->SetTitleOffset(.2);
    ...
    h10->GetYaxis()->SetLabelFont(62); // Absolute font size in pixel (precision 3)
    h10->GetYaxis()->SetLabelSize(0.1);
    h10->GetYaxis()->SetRangeUser(0,2.9);
    h10->GetXaxis()->SetRangeUser(-10,0.);
    h10->GetYaxis()->CenterTitle();
    ...
    TLine *line1 = new TLine(-10,1.,0.,1.);
    line1->SetLineStyle(2);
    line1->Draw("same");
    ...
    //save plot
    if (saveplots){
      c101->SaveAs("plots/20161027/w+jets/semilep/reco/Sin_theta_alt_cumulative_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if( eta ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/Eta_abs_semilep_lep_bkg");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    h10->GetYaxis()->SetLabelFont(62); // Absolute font size in pixel (precision 3)
    h10->GetYaxis()->SetLabelSize(0.1);
    h10->GetYaxis()->SetRangeUser(.9,3.9);
    ...
    //save plot
    if (saveplots){
      c110->SaveAs("plots/20161027/w+jets/semilep/reco/Eta_l_cumulative_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if( eta ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/Eta_abs_semilep_had_bkg");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    h->SetTitle("Reco #eta distributions");
    h->GetXaxis()->SetTitle("log_{10}#phi^{*}_{#eta}");
    ...
    h10->GetYaxis()->SetLabelFont(62); // Absolute font size in pixel (precision 3)
    h10->GetYaxis()->SetLabelSize(0.1);
    h10->GetYaxis()->SetRangeUser(.7,1.4);
    h10->GetXaxis()->SetRangeUser(0,5.);
    h10->GetYaxis()->CenterTitle();
    ...
    //save plot
    if (saveplots){
      c99->SaveAs("plots/20161027/w+jets/semilep/reco/Eta_h_cumulative_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if( pt ){
    ...
    h10->GetYaxis()->SetLabelFont(62); // Absolute font size in pixel (precision 3)
    h10->GetYaxis()->SetLabelSize(0.1);
    h10->GetYaxis()->SetRangeUser(.4,8.9);
    ...
    //save plot
    if (saveplots){
      c98->SaveAs("plots/20161027/w+jets/semilep/reco/Pt_l_cumulative_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if( pt ){
    ...
    h10->GetYaxis()->SetLabelFont(62); // Absolute font size in pixel (precision 3)
    h10->GetYaxis()->SetLabelSize(0.1);
    h10->GetYaxis()->SetRangeUser(0,1.1);
    h10->GetXaxis()->SetRangeUser(0.,150e3);
    h10->GetYaxis()->CenterTitle();
    ...
    //save plot
    if (saveplots){
      c111->SaveAs("plots/20161027/w+jets/semilep/reco/Pt_h_cumulative_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if( phistar ){
    ...
    for( int i = 0; i < nbinsx+1; ++i ){
      ...
      cout << "sig: " << hc->GetBinContent(i) << " bkg: " << hc2->GetBinContent(i) 
	   << " cut: " << hc->GetXaxis()->GetBinCenter(i) << endl;
    }
    ...
    h10->GetYaxis()->SetLabelFont(62); // Absolute font size in pixel (precision 3)
    h10->GetYaxis()->SetLabelSize(0.1);
    h10->GetYaxis()->SetRangeUser(0,14.1);
    ...
    //save plot
    if (saveplots){
      c96->SaveAs("plots/20161027/w+jets/semilep/reco/PhiStar_cumulative_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if( phiacop ){
    ...
    //TH1F *h2		= (TH1F*)f->Get("361510/plotEventAlgs/taus/Phi_acop_semilep_bkg");
    ...
    h10->GetYaxis()->SetLabelFont(62); // Absolute font size in pixel (precision 3)
    h10->GetYaxis()->SetLabelSize(0.1);
    h10->GetYaxis()->SetRangeUser(0,19.1);
    ...
    //save plot
    if (saveplots){
      c97->SaveAs("plots/20161027/w+jets/semilep/reco/PhiAcop_cumulative_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if( alpha ){
    ...
    gStyle->SetTitleX(0.5);
    gStyle->SetTitleAlign(23);
    hist_leg = new TLegend(0.25,0.47,0.35,0.77);
    hist_leg->SetFillColor(0);
    hist_leg->SetFillStyle(0);
    hist_leg->SetLineColor(1);
    hist_leg->SetShadowColor(0);
    ...
    //hcum2= h2->GetCumulative();
    TH1* hc = h->GetCumulative(kFALSE);
    TH1* hc2 = h2->GetCumulative(kFALSE);
    //TH1* hc = new TH1F;
    //TH1* hc2= new TH1F;
    ///for( int i = 0; i < hcum->GetXaxis()->GetNbins() + 1; ++i ){
    // hc->Fill( 1 - i );
    // hc2->Fill( 1 - i );
    //}
    // Define the Canvas
    TCanvas *c120 = new TCanvas("c120", "c120", 800, 600);

    c120->SetRightMargin(0.15);
    c120->SetLeftMargin(0.14);
    c120->SetBottomMargin(0.16);
    ...
    // loop over bins 31 to 90
    for( int i = 0; i < nbinsx+1 ; ++i ){
      if( hc->GetBinContent(i)>0&&hc->GetBinContent(i)<1&&hc2->GetBinContent(i)>0&&hc2->GetBinContent(i)<1){
	dt9->SetPoint( i, hc->GetBinContent(i), hc2->GetBinContent(i));
	//	cout << hc->GetBinContent(i) <<  hc2->GetBinContent(i) << endl;
      }
    }
    ...
    // lower plot will be in pad
    c120->cd();          // Go back to the main canvas before defining pad2
    TPad *pad2 = new TPad("pad2", "pad2", 0, 0.05, 1, 0.3);
    pad2->SetTopMargin(0);
    pad2->SetBottomMargin(0.3);
    pad2->SetGridx(); // vertical grid
    ...
    TLine *line1 = new TLine(0,1.,3.2,1.);
    line1->SetLineStyle(2);
    line1->Draw("same");
    ...
    //save plot
    if (saveplots){
      c120->SaveAs("plots/20161027/w+jets/semilep/reco/Alpha_cumulative_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if( etcross ){
    ...
    // Define the Canvas
    TCanvas *c121 = new TCanvas("c121", "c121", 800, 600);

    c121->SetRightMargin(0.15);
    c121->SetLeftMargin(0.14);
    c121->SetBottomMargin(0.16);
    ...
    // loop over bins 31 to 90
    for( int i = 0; i < nbinsx+1; ++i ){
      dt10->SetPoint( i, hc->GetBinContent(i), hc2->GetBinContent(i));
    }
    ...
    // lower plot will be in pad
    c121->cd();          // Go back to the main canvas before defining pad2
    TPad *pad2 = new TPad("pad2", "pad2", 0, 0.05, 1, 0.3);
    pad2->SetTopMargin(0);
    pad2->SetBottomMargin(0.3);
    pad2->SetGridx(); // vertical grid
    ...
    h10->SetLineWidth(1);
    //    h10->SetMarkerStyle(21);
    h10->GetXaxis()->SetTitle("|(#slash{E}_{T}#times#hat{t})_{Z}| [MeV]");
    h10->GetYaxis()->SetTitle("Ratio Z/w+jets");
    h10->GetXaxis()->SetTitleSize(0.07);
    h10->GetYaxis()->SetTitleSize(0.07);
    h10->GetXaxis()->SetTitleOffset(.2);
    ...
    //save plot
    if (saveplots){
      c121->SaveAs("plots/20161027/w+jets/semilep/reco/Et_cross_abs_cumulative_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if(  eff ){
    ...
    gStyle->SetTitleX(0.5);
    gStyle->SetTitleAlign(23);
    hist_leg1 = new TLegend(0.86,0.45,1,0.90);
    ...
    dt6->SetLineColor(40);
    dt9->SetLineColor(8);
    dt9->SetMarkerColor(8);
    dt9->SetMarkerStyle(8);
    dt9->SetMarkerSize(.1);
    dt10->SetLineColor(40);
    dt7->SetLineStyle(2);
    dt8->SetLineStyle(2);
    dt9->SetLineStyle(2);
    dt10->SetLineStyle(2);
    ...
    hist_leg1->AddEntry(dt5, Form("1-sin(#theta^{*}_{#eta})"),"l");
    hist_leg1->AddEntry(dt6, Form("a_{T}"),"l");
    hist_leg1->AddEntry(dt9, Form("#alpha(#slash{E}_{T},#hat{t})"),"l");
    hist_leg1->AddEntry(dt10, Form("|(#slash{E}_{T}#times#hat{t})_{Z}|"),"l");
    dt->Draw("AL");
    dt2->Draw("same");
    dt3->Draw("same");
    dt8->Draw("same");
    ...
    //save plot
    if (saveplots){
      c20->SaveAs("plots/20161027/w+jets/semilep/reco/Eff_lh_Ztautau_vs_w+jets_reco.pdf");
    }    

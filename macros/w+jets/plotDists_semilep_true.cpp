...
void plotDists_semilep_true(){
  ...
  if (at){
    ...
    h->GetYaxis()->SetRangeUser(0.,250e-6);
    ...
    //save plot
    if (saveplots){
      c1->SaveAs("plots/20161016/w+jets/semilep/true/At_semilep_Ztautau_vs_w+jets_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c2->SaveAs("plots/20161016/w+jets/semilep/true/Pt_semilep_l_Ztautau_vs_w+jets_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c7->SaveAs("plots/20161016/w+jets/semilep/true/Pt_semilep_h_Ztautau_vs_w+jets_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/Eta_semilep_lep_bkg_truth");
    int rebinval = 1;
    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c3->SaveAs("plots/20161016/w+jets/semilep/true/Eta_semilep_l_Ztautau_vs_w+jets_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/Eta_semilep_had_bkg_truth");
    int rebinval = 1;
    TGaxis::SetMaxDigits(3); 
    h->SetTitle("True #eta distributions");
    ...
    //save plot
    if (saveplots){
      c8->SaveAs("plots/20161016/w+jets/semilep/true/Eta_semilep_h_Ztautau_vs_w+jets_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c4->SaveAs("plots/20161016/w+jets/semilep/true/PhiAcop_semilep_Ztautau_vs_w+jets_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c5->SaveAs("plots/20161016/w+jets/semilep/true/Sin_theta_semilep_Ztautau_vs_w+jets_true.pdf");
    }    
  }
  ...
  if (at){
    ...
    //save plot
    if (saveplots){
      c6->SaveAs("plots/20161016/w+jets/semilep/true/PhiStar_semilep_Ztautau_vs_w+jets_true.pdf");
    }    
  }
}

...
void plotEff_dilep_reco(){
  ...
  if( aT ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/At_dilep_bkg");
    int rebinval = 1;
    ...
    //save plot
    if (saveplots){
      c102->SaveAs("plots/20161016/w+jets/dilep/reco/At_cumulative_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if( sintheta ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/Sin_theta_dilep_bkg");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c101->SaveAs("plots/20161016/w+jets/dilep/reco/Sin_theta_cumulative_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if( eta ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/Eta_abs_dilep_bkg");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    h10->GetYaxis()->SetLabelFont(62); // Absolute font size in pixel (precision 3)
    h10->GetYaxis()->SetLabelSize(0.1);
    h10->GetYaxis()->SetRangeUser(0.8,1.4);
    ...
    //save plot
    if (saveplots){
      c99->SaveAs("plots/20161016/w+jets/dilep/reco/Eta_l_cumulative_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if( pt ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/Pt_dilep_bkg");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    h10->GetYaxis()->SetLabelFont(62); // Absolute font size in pixel (precision 3)
    h10->GetYaxis()->SetLabelSize(0.1);
    h10->GetYaxis()->SetRangeUser(0.5,1.4);
    ...
    //save plot
    if (saveplots){
      c98->SaveAs("plots/20161016/w+jets/dilep/reco/Pt_l_cumulative_Ztautau_vs_w+jets_h_reco.pdf");
    }    
  }
  ...
  if( phistar ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/PhiStarEta_dilep_bkg");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    h10->GetYaxis()->SetLabelFont(62); // Absolute font size in pixel (precision 3)
    h10->GetYaxis()->SetLabelSize(0.1);
    h10->GetYaxis()->SetRangeUser(0,9.9);
    ...
    //save plot
    if (saveplots){
      c96->SaveAs("plots/20161016/w+jets/dilep/reco/PhiStar_cumulative_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if( phiacop ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/Phi_acop_dilep_bkg");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c97->SaveAs("plots/20161016/w+jets/dilep/reco/PhiAcop_cumulative_Ztautau_vs_w+jets_reco.pdf");
    }    
  }
  ...
  if(  eff ){
    ...
    //save plot
    if (saveplots){
      c20->SaveAs("plots/20161016/w+jets/dilep/reco/Eff_ll_Ztautau_vs_w+jets_reco.pdf");
    }    

...
void plotEff_semilep_true(){
  ...
  if( aT ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/At_semilep_bkg_truth");
    int rebinval = 1;
    ...
    //save plot
    if (saveplots){
      c102->SaveAs("plots/20161016/w+jets/semilep/true/At_cumulative_Ztautau_vs_w+jets_true.pdf");
    }    
  }
  ...
  if( sintheta ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/Sin_theta_semilep_bkg_truth");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    for( int i = 0; i < 2001; ++i ){
      dt5->SetPoint( i, hc2->GetBinContent(i), hc->GetBinContent(i));
    }
    ...
    //save plot
    if (saveplots){
      c101->SaveAs("plots/20161016/w+jets/semilep/true/Sin_theta_cumulative_Ztautau_vs_w+jets_true.pdf");
    }    
  }
  ...
  if( eta ){
    ...
    hist_leg->SetTextFont(62);
    hist_leg->SetBorderSize(0);
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/Eta_abs_semilep_lep_bkg_truth");
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/Eta_abs_semilep_lep_bkg_truth");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c110->SaveAs("plots/20161016/w+jets/semilep/true/Eta_l_cumulative_Ztautau_vs_w+jets_true.pdf");
    }    
  }
  ...
  if( eta ){
    ...
    hist_leg->SetTextFont(62);
    hist_leg->SetBorderSize(0);
    TH1F *h		= (TH1F*)f->Get("361510/plotEventAlgs/taus/Eta_abs_semilep_had_bkg_truth");
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/Eta_abs_semilep_had_bkg_truth");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    h->SetTitle("True #eta distributions");
    h->GetXaxis()->SetTitle("log_{10}#phi^{*}_{#eta}");
    ...
    h10->GetYaxis()->SetLabelFont(62); // Absolute font size in pixel (precision 3)
    h10->GetYaxis()->SetLabelSize(0.1);
    h10->GetYaxis()->SetRangeUser(.9,2.9);
    h10->GetXaxis()->SetRangeUser(0,5.);
    h10->GetYaxis()->CenterTitle();
    ...
    //save plot
    if (saveplots){
      c99->SaveAs("plots/20161016/w+jets/semilep/true/Eta_h_cumulative_Ztautau_vs_w+jets_true.pdf");
    }    
  }
  ...
  if( pt ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/Pt_semilep_lep_bkg_truth");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    h10->GetYaxis()->SetLabelFont(62); // Absolute font size in pixel (precision 3)
    h10->GetYaxis()->SetLabelSize(0.1);
    h10->GetYaxis()->SetRangeUser(.9,9.9);
    ...
    //save plot
    if (saveplots){
      c98->SaveAs("plots/20161016/w+jets/semilep/true/Pt_l_cumulative_Ztautau_vs_w+jets_true.pdf");
    }    
  }
  ...
  if( pt ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/Pt_semilep_had_bkg_truth");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    h->SetTitle("True p_{T} distributions");
    h->GetXaxis()->SetTitle("log_{10}#phi^{*}_{#eta}");
    ...
    // loop over bins 31 to 90
    for( int i = 21; i < 201; ++i ){
      dt8->SetPoint( i, hc2->GetBinContent(i), hc->GetBinContent(i));
    }
    ...
    //save plot
    if (saveplots){
      c111->SaveAs("plots/20161016/w+jets/semilep/true/Pt_h_cumulative_Ztautau_vs_w+jets_true.pdf");
    }    
  }
  ...
  if( phistar ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/PhiStarEta_semilep_bkg_truth");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c96->SaveAs("plots/20161016/w+jets/semilep/true/PhiStar_cumulative_Ztautau_vs_w+jets_true.pdf");
    }    
  }
  ...
  if( phiacop ){
    ...
    TH1F *h2       	= (TH1F*)f1->Get("361101/plotEventAlgs/taus/Phi_acop_semilep_bkg_truth");
    int rebinval = 1;
    //    TGaxis::SetMaxDigits(3); 
    ...
    //save plot
    if (saveplots){
      c97->SaveAs("plots/20161016/w+jets/semilep/true/PhiAcop_cumulative_Ztautau_vs_w+jets_true.pdf");
    }    
  }
  ...
  if(  eff ){
    ...
    //save plot
    if (saveplots){
      c20->SaveAs("plots/20161016/w+jets/semilep/true/Eff_lh_Ztautau_vs_w+jets_true.pdf");
    }    
